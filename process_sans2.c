...
// bank 0
      ...
      if (an_valid && kv_valid && kh_valid)
      {
        ...
        if ( (k_diff > -20) && (k_diff < 20) ) 
        {
          ...
          if(xPos >= 0 )
          {
            ...
            if(yPos >= 0 )
            {
              binpos = (yPos * b0_axis_0.len) + xPos ;
      ...
      if (    (num_banks > 1) && (k_diff != 9999)
           && (pos_kv > 135) && (pos_kv < 385) 
           && (pos_kh > 135) && (pos_kh < 385)      
         )
      {
        int xd, yd, p;
...
// bank 1
      if ((num_banks > 1) && (an_valid && kv_valid))
      {
        ...
        if(xPos >= 0 )   
        {
          ...
          if(yPos >= 60 )  // leave space for kdiff statistics
          {
            binpos = (yPos * b1_axis_0.len) + xPos ;
...
// bank 2
      if ((num_banks > 2) && (an_valid && kh_valid))
      {
        ...
        if(xPos >= 0 )  
        {
          ...
          if(yPos >= 1 )  // leave space for statistics
          {
            binpos = (yPos * b2_axis_0.len) + xPos ;
